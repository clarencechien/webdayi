...
console.log('╔════════════════════════════════════════════════════════╗');
console.log('║   TDD Tests: Laplace Smoothing (Solution B)           ║');
console.log('╚════════════════════════════════════════════════════════╝\n');
...
test('Test 2.2: Laplace smoothing for unseen unigram', () => {
  ...
  const unseenChar = '🦄';  // Emoji unlikely in Chinese corpus
...
test('Test 3.2: Laplace smoothing for unseen bigram', () => {
  ...
  const char2 = '🦄';  // Unlikely in corpus
...
if (passedTests === totalTests) {
  ...
  console.log(`\n✗ ${totalTests - passedTests} test(s) FAILED. Review implementation.\n`);
  process.exit(1);
}
